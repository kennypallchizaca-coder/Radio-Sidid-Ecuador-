        ...
        >
          ...
          >
            ...
            <div className="hidden sm:flex flex-col leading-tight">
              {/* Amarillo → Azul → Rojo */}
              <span className="text-sm font-extrabold tracking-tight bg-gradient-to-r from-yellow-400 via-blue-500 to-red-500 bg-clip-text text-transparent whitespace-nowrap">
